...
import {
  registerSaga, loginSaga, refreshSaga, logoutSaga, changePasswordSaga, updateUserPassword,
} from './authSagas';
...
import {
  changeMarkSaga, setOfferStatusSaga, addOfferSaga, getOffers, banOrPandingOffer,
} from './offerSagas';
import {
  previewSaga,
  getDialog,
...
function* rootSaga() {
  ...
  yield takeLatest(ACTION.AUTH_ACTION_CHANGE_PASSWORD, changePasswordSaga);
  yield takeLatest(ACTION.AUTH_ACTION_UPDATE_PASSWORD, updateUserPassword);
